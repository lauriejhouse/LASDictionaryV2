...
protocol QuestionsVideoPlayerDelegate {
...
let QuestionsvideoContext: UnsafeMutableRawPointer? = nil

class QuestionsVideoPlayer: NSObject {
    ...
    private var playerView: QuestionsPlayerView?
    
    private var autoRepeatPlay: Bool = true
    private var autoPlay: Bool = true
    
    var delegate: QuestionsVideoPlayerDelegate?
    ...
    convenience init (urlAsset: NSURL, view: QuestionsPlayerView, startAutoPlay: Bool = true, repeatAfterEnd: Bool = true) {
        self.init()
