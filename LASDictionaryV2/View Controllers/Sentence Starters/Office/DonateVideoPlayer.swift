...
protocol DonateVideoPlayerDelegate {
...
let DonateevideoContext: UnsafeMutableRawPointer? = nil

class DonateVideoPlayer: NSObject {
    ...
    private var playerView: DonatePlayerView?
    
    private var autoRepeatPlay: Bool = true
    private var autoPlay: Bool = true
    
    var delegate: DonateVideoPlayerDelegate?
    ...
    convenience init (urlAsset: NSURL, view: DonatePlayerView, startAutoPlay: Bool = true, repeatAfterEnd: Bool = true) {
        self.init()
