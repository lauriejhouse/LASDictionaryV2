...
protocol EatVideoPlayerDelegate {
...
let EatvideoContext: UnsafeMutableRawPointer? = nil

class EatVideoPlayer: NSObject {
    ...
    private var playerView: EatPlayerView?
    
    private var autoRepeatPlay: Bool = true
    private var autoPlay: Bool = true
    
    var delegate: EatVideoPlayerDelegate?
    ...
    convenience init (urlAsset: NSURL, view: EatPlayerView, startAutoPlay: Bool = true, repeatAfterEnd: Bool = true) {
        self.init()
