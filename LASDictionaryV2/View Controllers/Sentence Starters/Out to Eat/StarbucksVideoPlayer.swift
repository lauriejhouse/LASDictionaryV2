...
protocol StarbucksVideoPlayerDelegate {
...
let videoStarbucksContext: UnsafeMutableRawPointer? = nil

class StarbucksVideoPlayer: NSObject {
    ...
    private var playerView: StarbucksPlayerView?
    
    private var autoRepeatPlay: Bool = true
    private var autoPlay: Bool = true
    
    var delegate: StarbucksVideoPlayerDelegate?
    ...
    convenience init (urlAsset: NSURL, view: StarbucksPlayerView, startAutoPlay: Bool = true, repeatAfterEnd: Bool = true) {
        self.init()
