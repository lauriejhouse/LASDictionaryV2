...
protocol MedicalVideoPlayerDelegate {
...
let videoMedicalContext: UnsafeMutableRawPointer? = nil

class MedicalVideoPlayer: NSObject {
    ...
    private var playerView: MedicalPlayerView?
    
    private var autoRepeatPlay: Bool = true
    private var autoPlay: Bool = true
    
    var delegate: MedicalVideoPlayerDelegate?
    ...
    convenience init (urlAsset: NSURL, view: MedicalPlayerView, startAutoPlay: Bool = true, repeatAfterEnd: Bool = true) {
        self.init()
