...
protocol OfficeVideoPlayerDelegate {
...
let OfficevideoContext: UnsafeMutableRawPointer? = nil

class OfficeVideoPlayer: NSObject {
    ...
    private var playerView: OfficePlayerView?
    
    private var autoRepeatPlay: Bool = true
    private var autoPlay: Bool = true
    
    var delegate: OfficeVideoPlayerDelegate?
    ...
    convenience init (urlAsset: NSURL, view: OfficePlayerView, startAutoPlay: Bool = true, repeatAfterEnd: Bool = true) {
        self.init()
