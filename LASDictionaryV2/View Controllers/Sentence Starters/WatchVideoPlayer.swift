...
protocol WatchVideoPlayerDelegate {
...
let videoContextWatch: UnsafeMutableRawPointer? = nil

class WatchVideoPlayer: NSObject {
    ...
    private var playerView: WatchPlayerView?
    
    private var autoRepeatPlay: Bool = true
    private var autoPlay: Bool = true
    
    var delegate: WatchVideoPlayerDelegate?
    ...
    convenience init (urlAsset: NSURL, view: WatchPlayerView, startAutoPlay: Bool = true, repeatAfterEnd: Bool = true) {
        self.init()
