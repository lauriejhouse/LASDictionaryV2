...
protocol sendMeVideoPlayerDelegate {
...
let sendMevideoContext: UnsafeMutableRawPointer? = nil

class sendMeVideoPlayer: NSObject {
    ...
    private var playerView: sendMePlayerView?
    ...
    convenience init (urlAsset: NSURL, view: sendMePlayerView, startAutoPlay: Bool = true, repeatAfterEnd: Bool = true) {
        self.init()
