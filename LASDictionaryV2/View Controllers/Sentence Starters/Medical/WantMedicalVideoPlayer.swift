...
protocol WantMedicalVideoPlayerDelegate {
...
let WantMedicalvideoContext: UnsafeMutableRawPointer? = nil

class WantMedicalVideoPlayer: NSObject {
    ...
    private var playerView: WantMedicalPlayerView?
    
    private var autoRepeatPlay: Bool = true
    private var autoPlay: Bool = true
    
    var delegate: WantMedicalVideoPlayerDelegate?
    ...
    convenience init (urlAsset: NSURL, view: WantMedicalPlayerView, startAutoPlay: Bool = true, repeatAfterEnd: Bool = true) {
        self.init()
